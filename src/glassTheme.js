  ...
  return useMemo(
    () => ({
      theme: {
        ...
        token: {
          // Glass-specific shape overrides — other tokens come from baseTheme in main.jsx
          borderRadius:   12,
          borderRadiusLG: 12,
          borderRadiusSM: 8,
          borderRadiusXS: 6,
      ...
      modal: {
        classNames: { container: styles.modalContainer },
      },
      button: {
        classNames: ({ props }) => ({
          root: clsx(
      ...
      popover: {
        classNames: { container: styles.glassBox },
      },
      switch: {
        classNames: { root: styles.switchRoot },
      },
      radio: {
        classNames: { root: styles.radioButtonRoot },
      },
      segmented: {
