...
| Connector strong visual | DONE | 4 stacked CSS-classed paths: outer-glow (20px blur 8px), mid-glow (10px blur 4px), inner-glow (4px blur 1px), core (2.5px); pulse animation 2.5s; pinch dot at bezier midpoint; z-index:2 on SVG prevents fragment cards covering lines; glow opacity raised 3× | Session 11 |
